...
#else:
syst_names_now=['jetup','jetdown','tup','tdown','uup','udown']
cutbasedvars = [
...
#						print "FAKES",self.histoFAKES.Integral()
		...
		self.outputfile=ROOT.TFile("FAKESmethod2forcombine"+sys.argv[1]+".root","recreate")
		self.outputfile.cd()
...
#			print self.dir0
			self.dir0.Cd("FAKESmethod2forcombine"+sys.argv[1]+".root:/"+key[0])
#    print dir0
#			print histos[key]
