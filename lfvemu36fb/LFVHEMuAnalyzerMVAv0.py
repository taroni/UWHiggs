...
pu_corrector = PileupWeight.PileupWeight('MORIOND17', *pu_distributions)
id_corrector  = MuonPOGCorrections.make_muon_pog_PFMedium_2016ReReco()
iso_corrector = MuonPOGCorrections.make_muon_pog_TightIso_2016ReReco("Medium")
...
class LFVHEMuAnalyzerMVAv0(MegaBase):
    tree = 'em/final/Ntuple'
    def __init__(self, tree, outfile, **kwargs):
        self.channel='EMu'
        super(LFVHEMuAnalyzerMVAv0, self).__init__(tree, outfile, **kwargs)
        ...
        self.WZTo2L2Q_weight=8.91328638844e-07
        self.VVTo2L2Nu_weight=5.534702e-08
        self.WWTo1L1Nu2Q_weight=1.14858944695e-07
        self.WZJToLLLNu_weight=7.77410062009e-07
        self.WZTo1L1Nu2Q_weight=2.54725706507e-08
        self.WZTo1L3Nu_weight=3.26075777445e-07
        self.ZZTo2L2Q_weight=4.16766846027e-08
        self.ZZTo4L_weight=1.3202628761e-06

        self.DYlowmass_weight=1.99619334706e-08

        self.WGToLNuG_weight=1.03976258739e-07
        self.WGstarToLNuEE_weight=1.56725042226e-06#0.00000564158
        self.WGstarToLNuMuMu_weight=1.25890428e-06

        self.ST_tW_antitop_weight=5.1347926337e-06
        self.ST_tW_top_weight=5.12021723529e-06
        self.ST_t_antitop_weight=1.13550232399e-06
        self.ST_t_top_weight=6.65352488562e-07
        self.TT_weight=1.95706467028e-05

        self.WW_weight= 0.000119415057363
        self.WZ_weight= 4.713e-05
        self.ZZ_weight=1.66888201167e-05

        self.GluGluHTo_weight=2.07059122633e-06
        self.GluGlu_LFV_HToMuTau_weight=1.9432e-06
        self.VBFHTo_weight=4.23479177085e-08
        self.VBF_LFV_HToMuTau_weight= 2.26629913711e-07 
        self.GluGlu_LFV_HToETau_weight=1.9432e-06
        self.VBF_LFV_HToETau_weight=1.83818883478e-07  
...
#        self.sysdir=['nosys']
        if self.is_WJet:
            self.binned_weight=[2.97910498,0.238802321,0.123207369,0.058214862,0.063292701]
        elif self.is_DYJet:
            self.binned_weight=[0.117315804,0.016233898,0.016725261,0.017545741,0.021544426]
        else:
 ...
 #       pu=1
        ...
        muisocorr = iso_corrector(getattr(row, self.mym1+'Pt'), abs(getattr(row, self.mym1+'Eta')))
