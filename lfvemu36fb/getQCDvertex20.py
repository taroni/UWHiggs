	        ...
	        for var in vars:
	        	for sign in ['ss','allfakes/ss']:
	        		for j in range(2):
						...
						self.histodata=None
						self.histoQCD=None
	        				for filename in os.listdir("results/Oct30/LFVHEMuAnalyzerMVA_vertices"):
							if "FAKES" in filename or "QCD" in filename: continue
	        					file=ROOT.TFile("results/Oct30/LFVHEMuAnalyzerMVA_vertices/"+filename)
