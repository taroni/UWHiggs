...
class LFVHEMuAnalyzerMVAv6ztautau(MegaBase):
    tree = 'em/final/Ntuple'
    def __init__(self, tree, outfile, **kwargs):
        self.channel='EMu'
        super(LFVHEMuAnalyzerMVAv6ztautau, self).__init__(tree, outfile, **kwargs)
...
#            if btagweight<0:btagweight=0
            ...
            if row.mMtToPfMet_type1>60:continue
            if row.mPt>40:continue
            if row.e_m_Mass<30:continue
            if row.e_m_Mass>70:continue
