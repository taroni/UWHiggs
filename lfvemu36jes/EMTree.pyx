...
cdef class EMTree:
    ...
    cdef TBranch* eMatchesEle24Tau20L1Filter_branch
    cdef float eMatchesEle24Tau20L1Filter_value

    cdef TBranch* eMatchesEle24Tau20L1Path_branch
    cdef float eMatchesEle24Tau20L1Path_value
    ...
    cdef TBranch* e_m_MvaMet_branch
    cdef float e_m_MvaMet_value

    cdef TBranch* e_m_MvaMetCovMatrix00_branch
    cdef float e_m_MvaMetCovMatrix00_value

    cdef TBranch* e_m_MvaMetCovMatrix01_branch
    cdef float e_m_MvaMetCovMatrix01_value

    cdef TBranch* e_m_MvaMetCovMatrix10_branch
    cdef float e_m_MvaMetCovMatrix10_value

    cdef TBranch* e_m_MvaMetCovMatrix11_branch
    cdef float e_m_MvaMetCovMatrix11_value

    cdef TBranch* e_m_MvaMetPhi_branch
    cdef float e_m_MvaMetPhi_value
    ...
    cdef TBranch* e_m_collinearmass_EleEnDown_branch
    cdef float e_m_collinearmass_EleEnDown_value

    cdef TBranch* e_m_collinearmass_EleEnUp_branch
    cdef float e_m_collinearmass_EleEnUp_value
    ...
    cdef TBranch* e_m_collinearmass_MuEnDown_branch
    cdef float e_m_collinearmass_MuEnDown_value

    cdef TBranch* e_m_collinearmass_MuEnUp_branch
    cdef float e_m_collinearmass_MuEnUp_value
    ...
    cdef setup_branches(self, TTree* the_tree):
        ...
        if not self.Ele45L1JetTauSeededGroup_branch and "Ele45L1JetTauSeededGroup":
            warnings.warn( "EMTree: Expected branch Ele45L1JetTauSeededGroup does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.Ele45L1JetTauSeededPass_branch and "Ele45L1JetTauSeededPass":
            warnings.warn( "EMTree: Expected branch Ele45L1JetTauSeededPass does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.Ele45L1JetTauSeededPrescale_branch and "Ele45L1JetTauSeededPrescale":
            warnings.warn( "EMTree: Expected branch Ele45L1JetTauSeededPrescale does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.doubleTauCmbIso35RegGroup_branch and "doubleTauCmbIso35RegGroup":
            warnings.warn( "EMTree: Expected branch doubleTauCmbIso35RegGroup does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.doubleTauCmbIso35RegPrescale_branch and "doubleTauCmbIso35RegPrescale":
            warnings.warn( "EMTree: Expected branch doubleTauCmbIso35RegPrescale does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.doubleTauCmbIso40Group_branch and "doubleTauCmbIso40Group":
            warnings.warn( "EMTree: Expected branch doubleTauCmbIso40Group does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.doubleTauCmbIso40Pass_branch and "doubleTauCmbIso40Pass":
            warnings.warn( "EMTree: Expected branch doubleTauCmbIso40Pass does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.doubleTauCmbIso40Prescale_branch and "doubleTauCmbIso40Prescale":
            warnings.warn( "EMTree: Expected branch doubleTauCmbIso40Prescale does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.doubleTauCmbIso40RegGroup_branch and "doubleTauCmbIso40RegGroup":
            warnings.warn( "EMTree: Expected branch doubleTauCmbIso40RegGroup does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.doubleTauCmbIso40RegPass_branch and "doubleTauCmbIso40RegPass":
            warnings.warn( "EMTree: Expected branch doubleTauCmbIso40RegPass does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.doubleTauCmbIso40RegPrescale_branch and "doubleTauCmbIso40RegPrescale":
            warnings.warn( "EMTree: Expected branch doubleTauCmbIso40RegPrescale does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.eErsatzGenEta_branch and "eErsatzGenEta":
            warnings.warn( "EMTree: Expected branch eErsatzGenEta does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.eErsatzGenM_branch and "eErsatzGenM":
            warnings.warn( "EMTree: Expected branch eErsatzGenM does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.eErsatzGenPhi_branch and "eErsatzGenPhi":
            warnings.warn( "EMTree: Expected branch eErsatzGenPhi does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.eErsatzGenpT_branch and "eErsatzGenpT":
            warnings.warn( "EMTree: Expected branch eErsatzGenpT does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.eErsatzGenpX_branch and "eErsatzGenpX":
            warnings.warn( "EMTree: Expected branch eErsatzGenpX does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.eErsatzGenpY_branch and "eErsatzGenpY":
            warnings.warn( "EMTree: Expected branch eErsatzGenpY does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.eErsatzVispX_branch and "eErsatzVispX":
            warnings.warn( "EMTree: Expected branch eErsatzVispX does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.eErsatzVispY_branch and "eErsatzVispY":
            warnings.warn( "EMTree: Expected branch eErsatzVispY does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.eMatchesEle24Tau20Filter_branch and "eMatchesEle24Tau20Filter":
            warnings.warn( "EMTree: Expected branch eMatchesEle24Tau20Filter does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        #print "making eMatchesEle24Tau20L1Filter"
        self.eMatchesEle24Tau20L1Filter_branch = the_tree.GetBranch("eMatchesEle24Tau20L1Filter")
        #if not self.eMatchesEle24Tau20L1Filter_branch and "eMatchesEle24Tau20L1Filter" not in self.complained:
        if not self.eMatchesEle24Tau20L1Filter_branch and "eMatchesEle24Tau20L1Filter":
            warnings.warn( "EMTree: Expected branch eMatchesEle24Tau20L1Filter does not exist!"                " It will crash if you try and use it!",Warning)
            #self.complained.add("eMatchesEle24Tau20L1Filter")
        else:
            self.eMatchesEle24Tau20L1Filter_branch.SetAddress(<void*>&self.eMatchesEle24Tau20L1Filter_value)

        #print "making eMatchesEle24Tau20L1Path"
        self.eMatchesEle24Tau20L1Path_branch = the_tree.GetBranch("eMatchesEle24Tau20L1Path")
        #if not self.eMatchesEle24Tau20L1Path_branch and "eMatchesEle24Tau20L1Path" not in self.complained:
        if not self.eMatchesEle24Tau20L1Path_branch and "eMatchesEle24Tau20L1Path":
            warnings.warn( "EMTree: Expected branch eMatchesEle24Tau20L1Path does not exist!"                " It will crash if you try and use it!",Warning)
            #self.complained.add("eMatchesEle24Tau20L1Path")
        else:
            self.eMatchesEle24Tau20L1Path_branch.SetAddress(<void*>&self.eMatchesEle24Tau20L1Path_value)
        ...
        if not self.eMatchesEle24Tau20Path_branch and "eMatchesEle24Tau20Path":
            warnings.warn( "EMTree: Expected branch eMatchesEle24Tau20Path does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.eMatchesMu23Ele8DZFilter_branch and "eMatchesMu23Ele8DZFilter":
            warnings.warn( "EMTree: Expected branch eMatchesMu23Ele8DZFilter does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.eMatchesMu23Ele8DZPath_branch and "eMatchesMu23Ele8DZPath":
            warnings.warn( "EMTree: Expected branch eMatchesMu23Ele8DZPath does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.eMatchesMu23Ele8Filter_branch and "eMatchesMu23Ele8Filter":
            warnings.warn( "EMTree: Expected branch eMatchesMu23Ele8Filter does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.eMatchesMu23Ele8Path_branch and "eMatchesMu23Ele8Path":
            warnings.warn( "EMTree: Expected branch eMatchesMu23Ele8Path does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        #print "making e_m_MvaMet"
        self.e_m_MvaMet_branch = the_tree.GetBranch("e_m_MvaMet")
        #if not self.e_m_MvaMet_branch and "e_m_MvaMet" not in self.complained:
        if not self.e_m_MvaMet_branch and "e_m_MvaMet":
            warnings.warn( "EMTree: Expected branch e_m_MvaMet does not exist!"                " It will crash if you try and use it!",Warning)
            #self.complained.add("e_m_MvaMet")
        else:
            self.e_m_MvaMet_branch.SetAddress(<void*>&self.e_m_MvaMet_value)

        #print "making e_m_MvaMetCovMatrix00"
        self.e_m_MvaMetCovMatrix00_branch = the_tree.GetBranch("e_m_MvaMetCovMatrix00")
        #if not self.e_m_MvaMetCovMatrix00_branch and "e_m_MvaMetCovMatrix00" not in self.complained:
        if not self.e_m_MvaMetCovMatrix00_branch and "e_m_MvaMetCovMatrix00":
            warnings.warn( "EMTree: Expected branch e_m_MvaMetCovMatrix00 does not exist!"                " It will crash if you try and use it!",Warning)
            #self.complained.add("e_m_MvaMetCovMatrix00")
        else:
            self.e_m_MvaMetCovMatrix00_branch.SetAddress(<void*>&self.e_m_MvaMetCovMatrix00_value)

        #print "making e_m_MvaMetCovMatrix01"
        self.e_m_MvaMetCovMatrix01_branch = the_tree.GetBranch("e_m_MvaMetCovMatrix01")
        #if not self.e_m_MvaMetCovMatrix01_branch and "e_m_MvaMetCovMatrix01" not in self.complained:
        if not self.e_m_MvaMetCovMatrix01_branch and "e_m_MvaMetCovMatrix01":
            warnings.warn( "EMTree: Expected branch e_m_MvaMetCovMatrix01 does not exist!"                " It will crash if you try and use it!",Warning)
            #self.complained.add("e_m_MvaMetCovMatrix01")
        else:
            self.e_m_MvaMetCovMatrix01_branch.SetAddress(<void*>&self.e_m_MvaMetCovMatrix01_value)

        #print "making e_m_MvaMetCovMatrix10"
        self.e_m_MvaMetCovMatrix10_branch = the_tree.GetBranch("e_m_MvaMetCovMatrix10")
        #if not self.e_m_MvaMetCovMatrix10_branch and "e_m_MvaMetCovMatrix10" not in self.complained:
        if not self.e_m_MvaMetCovMatrix10_branch and "e_m_MvaMetCovMatrix10":
            warnings.warn( "EMTree: Expected branch e_m_MvaMetCovMatrix10 does not exist!"                " It will crash if you try and use it!",Warning)
            #self.complained.add("e_m_MvaMetCovMatrix10")
        else:
            self.e_m_MvaMetCovMatrix10_branch.SetAddress(<void*>&self.e_m_MvaMetCovMatrix10_value)

        #print "making e_m_MvaMetCovMatrix11"
        self.e_m_MvaMetCovMatrix11_branch = the_tree.GetBranch("e_m_MvaMetCovMatrix11")
        #if not self.e_m_MvaMetCovMatrix11_branch and "e_m_MvaMetCovMatrix11" not in self.complained:
        if not self.e_m_MvaMetCovMatrix11_branch and "e_m_MvaMetCovMatrix11":
            warnings.warn( "EMTree: Expected branch e_m_MvaMetCovMatrix11 does not exist!"                " It will crash if you try and use it!",Warning)
            #self.complained.add("e_m_MvaMetCovMatrix11")
        else:
            self.e_m_MvaMetCovMatrix11_branch.SetAddress(<void*>&self.e_m_MvaMetCovMatrix11_value)

        #print "making e_m_MvaMetPhi"
        self.e_m_MvaMetPhi_branch = the_tree.GetBranch("e_m_MvaMetPhi")
        #if not self.e_m_MvaMetPhi_branch and "e_m_MvaMetPhi" not in self.complained:
        if not self.e_m_MvaMetPhi_branch and "e_m_MvaMetPhi":
            warnings.warn( "EMTree: Expected branch e_m_MvaMetPhi does not exist!"                " It will crash if you try and use it!",Warning)
            #self.complained.add("e_m_MvaMetPhi")
        else:
            self.e_m_MvaMetPhi_branch.SetAddress(<void*>&self.e_m_MvaMetPhi_value)
        ...
        #print "making e_m_collinearmass_EleEnDown"
        self.e_m_collinearmass_EleEnDown_branch = the_tree.GetBranch("e_m_collinearmass_EleEnDown")
        #if not self.e_m_collinearmass_EleEnDown_branch and "e_m_collinearmass_EleEnDown" not in self.complained:
        if not self.e_m_collinearmass_EleEnDown_branch and "e_m_collinearmass_EleEnDown":
            warnings.warn( "EMTree: Expected branch e_m_collinearmass_EleEnDown does not exist!"                " It will crash if you try and use it!",Warning)
            #self.complained.add("e_m_collinearmass_EleEnDown")
        else:
            self.e_m_collinearmass_EleEnDown_branch.SetAddress(<void*>&self.e_m_collinearmass_EleEnDown_value)

        #print "making e_m_collinearmass_EleEnUp"
        self.e_m_collinearmass_EleEnUp_branch = the_tree.GetBranch("e_m_collinearmass_EleEnUp")
        #if not self.e_m_collinearmass_EleEnUp_branch and "e_m_collinearmass_EleEnUp" not in self.complained:
        if not self.e_m_collinearmass_EleEnUp_branch and "e_m_collinearmass_EleEnUp":
            warnings.warn( "EMTree: Expected branch e_m_collinearmass_EleEnUp does not exist!"                " It will crash if you try and use it!",Warning)
            #self.complained.add("e_m_collinearmass_EleEnUp")
        else:
            self.e_m_collinearmass_EleEnUp_branch.SetAddress(<void*>&self.e_m_collinearmass_EleEnUp_value)
        ...
        #print "making e_m_collinearmass_MuEnDown"
        self.e_m_collinearmass_MuEnDown_branch = the_tree.GetBranch("e_m_collinearmass_MuEnDown")
        #if not self.e_m_collinearmass_MuEnDown_branch and "e_m_collinearmass_MuEnDown" not in self.complained:
        if not self.e_m_collinearmass_MuEnDown_branch and "e_m_collinearmass_MuEnDown":
            warnings.warn( "EMTree: Expected branch e_m_collinearmass_MuEnDown does not exist!"                " It will crash if you try and use it!",Warning)
            #self.complained.add("e_m_collinearmass_MuEnDown")
        else:
            self.e_m_collinearmass_MuEnDown_branch.SetAddress(<void*>&self.e_m_collinearmass_MuEnDown_value)

        #print "making e_m_collinearmass_MuEnUp"
        self.e_m_collinearmass_MuEnUp_branch = the_tree.GetBranch("e_m_collinearmass_MuEnUp")
        #if not self.e_m_collinearmass_MuEnUp_branch and "e_m_collinearmass_MuEnUp" not in self.complained:
        if not self.e_m_collinearmass_MuEnUp_branch and "e_m_collinearmass_MuEnUp":
            warnings.warn( "EMTree: Expected branch e_m_collinearmass_MuEnUp does not exist!"                " It will crash if you try and use it!",Warning)
            #self.complained.add("e_m_collinearmass_MuEnUp")
        else:
            self.e_m_collinearmass_MuEnUp_branch.SetAddress(<void*>&self.e_m_collinearmass_MuEnUp_value)
        ...
        if not self.j1partonflavor_branch and "j1partonflavor":
            warnings.warn( "EMTree: Expected branch j1partonflavor does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.j1ptDown_branch and "j1ptDown":
            warnings.warn( "EMTree: Expected branch j1ptDown does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.j1ptUp_branch and "j1ptUp":
            warnings.warn( "EMTree: Expected branch j1ptUp does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.j1rawf_branch and "j1rawf":
            warnings.warn( "EMTree: Expected branch j1rawf does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.j2partonflavor_branch and "j2partonflavor":
            warnings.warn( "EMTree: Expected branch j2partonflavor does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.j2ptDown_branch and "j2ptDown":
            warnings.warn( "EMTree: Expected branch j2ptDown does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.j2ptUp_branch and "j2ptUp":
            warnings.warn( "EMTree: Expected branch j2ptUp does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.j2rawf_branch and "j2rawf":
            warnings.warn( "EMTree: Expected branch j2rawf does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.jb1csv_CSVL_branch and "jb1csv_CSVL":
            warnings.warn( "EMTree: Expected branch jb1csv_CSVL does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.jb1eta_CSVL_branch and "jb1eta_CSVL":
            warnings.warn( "EMTree: Expected branch jb1eta_CSVL does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.jb1hadronflavor_CSVL_branch and "jb1hadronflavor_CSVL":
            warnings.warn( "EMTree: Expected branch jb1hadronflavor_CSVL does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.jb1partonflavor_branch and "jb1partonflavor":
            warnings.warn( "EMTree: Expected branch jb1partonflavor does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.jb1partonflavor_CSVL_branch and "jb1partonflavor_CSVL":
            warnings.warn( "EMTree: Expected branch jb1partonflavor_CSVL does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.jb1phi_CSVL_branch and "jb1phi_CSVL":
            warnings.warn( "EMTree: Expected branch jb1phi_CSVL does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.jb1ptDown_branch and "jb1ptDown":
            warnings.warn( "EMTree: Expected branch jb1ptDown does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.jb1ptDown_CSVL_branch and "jb1ptDown_CSVL":
            warnings.warn( "EMTree: Expected branch jb1ptDown_CSVL does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.jb1ptUp_branch and "jb1ptUp":
            warnings.warn( "EMTree: Expected branch jb1ptUp does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.jb1ptUp_CSVL_branch and "jb1ptUp_CSVL":
            warnings.warn( "EMTree: Expected branch jb1ptUp_CSVL does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.jb1pt_CSVL_branch and "jb1pt_CSVL":
            warnings.warn( "EMTree: Expected branch jb1pt_CSVL does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.jb1pu_CSVL_branch and "jb1pu_CSVL":
            warnings.warn( "EMTree: Expected branch jb1pu_CSVL does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.jb1rawf_branch and "jb1rawf":
            warnings.warn( "EMTree: Expected branch jb1rawf does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.jb1rawf_CSVL_branch and "jb1rawf_CSVL":
            warnings.warn( "EMTree: Expected branch jb1rawf_CSVL does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.jb2csv_CSVL_branch and "jb2csv_CSVL":
            warnings.warn( "EMTree: Expected branch jb2csv_CSVL does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.jb2eta_CSVL_branch and "jb2eta_CSVL":
            warnings.warn( "EMTree: Expected branch jb2eta_CSVL does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.jb2hadronflavor_CSVL_branch and "jb2hadronflavor_CSVL":
            warnings.warn( "EMTree: Expected branch jb2hadronflavor_CSVL does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.jb2partonflavor_branch and "jb2partonflavor":
            warnings.warn( "EMTree: Expected branch jb2partonflavor does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.jb2partonflavor_CSVL_branch and "jb2partonflavor_CSVL":
            warnings.warn( "EMTree: Expected branch jb2partonflavor_CSVL does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.jb2phi_CSVL_branch and "jb2phi_CSVL":
            warnings.warn( "EMTree: Expected branch jb2phi_CSVL does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.jb2ptDown_branch and "jb2ptDown":
            warnings.warn( "EMTree: Expected branch jb2ptDown does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.jb2ptDown_CSVL_branch and "jb2ptDown_CSVL":
            warnings.warn( "EMTree: Expected branch jb2ptDown_CSVL does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.jb2ptUp_branch and "jb2ptUp":
            warnings.warn( "EMTree: Expected branch jb2ptUp does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.jb2ptUp_CSVL_branch and "jb2ptUp_CSVL":
            warnings.warn( "EMTree: Expected branch jb2ptUp_CSVL does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.jb2pt_CSVL_branch and "jb2pt_CSVL":
            warnings.warn( "EMTree: Expected branch jb2pt_CSVL does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.jb2pu_CSVL_branch and "jb2pu_CSVL":
            warnings.warn( "EMTree: Expected branch jb2pu_CSVL does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.jb2rawf_branch and "jb2rawf":
            warnings.warn( "EMTree: Expected branch jb2rawf does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.jb2rawf_CSVL_branch and "jb2rawf_CSVL":
            warnings.warn( "EMTree: Expected branch jb2rawf_CSVL does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.jet1PtJESClosure_Down_branch and "jet1PtJESClosure_Down":
            warnings.warn( "EMTree: Expected branch jet1PtJESClosure_Down does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.jet1PtJESClosure_Up_branch and "jet1PtJESClosure_Up":
            warnings.warn( "EMTree: Expected branch jet1PtJESClosure_Up does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.jet1PtJESTotal_Down_branch and "jet1PtJESTotal_Down":
            warnings.warn( "EMTree: Expected branch jet1PtJESTotal_Down does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.jet1PtJESTotal_Up_branch and "jet1PtJESTotal_Up":
            warnings.warn( "EMTree: Expected branch jet1PtJESTotal_Up does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.jet2PtJESClosure_Down_branch and "jet2PtJESClosure_Down":
            warnings.warn( "EMTree: Expected branch jet2PtJESClosure_Down does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.jet2PtJESClosure_Up_branch and "jet2PtJESClosure_Up":
            warnings.warn( "EMTree: Expected branch jet2PtJESClosure_Up does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.jet2PtJESTotal_Down_branch and "jet2PtJESTotal_Down":
            warnings.warn( "EMTree: Expected branch jet2PtJESTotal_Down does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.jet2PtJESTotal_Up_branch and "jet2PtJESTotal_Up":
            warnings.warn( "EMTree: Expected branch jet2PtJESTotal_Up does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.jetVeto30_JetSubTotalAbsoluteDown_branch and "jetVeto30_JetSubTotalAbsoluteDown":
            warnings.warn( "EMTree: Expected branch jetVeto30_JetSubTotalAbsoluteDown does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.jetVeto30_JetSubTotalAbsoluteUp_branch and "jetVeto30_JetSubTotalAbsoluteUp":
            warnings.warn( "EMTree: Expected branch jetVeto30_JetSubTotalAbsoluteUp does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.jetVeto30_JetSubTotalMCDown_branch and "jetVeto30_JetSubTotalMCDown":
            warnings.warn( "EMTree: Expected branch jetVeto30_JetSubTotalMCDown does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.jetVeto30_JetSubTotalMCUp_branch and "jetVeto30_JetSubTotalMCUp":
            warnings.warn( "EMTree: Expected branch jetVeto30_JetSubTotalMCUp does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.jetVeto30_JetSubTotalPileUpDown_branch and "jetVeto30_JetSubTotalPileUpDown":
            warnings.warn( "EMTree: Expected branch jetVeto30_JetSubTotalPileUpDown does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.jetVeto30_JetSubTotalPileUpUp_branch and "jetVeto30_JetSubTotalPileUpUp":
            warnings.warn( "EMTree: Expected branch jetVeto30_JetSubTotalPileUpUp does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.jetVeto30_JetSubTotalPtDown_branch and "jetVeto30_JetSubTotalPtDown":
            warnings.warn( "EMTree: Expected branch jetVeto30_JetSubTotalPtDown does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.jetVeto30_JetSubTotalPtUp_branch and "jetVeto30_JetSubTotalPtUp":
            warnings.warn( "EMTree: Expected branch jetVeto30_JetSubTotalPtUp does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.jetVeto30_JetSubTotalRelativeDown_branch and "jetVeto30_JetSubTotalRelativeDown":
            warnings.warn( "EMTree: Expected branch jetVeto30_JetSubTotalRelativeDown does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.jetVeto30_JetSubTotalRelativeUp_branch and "jetVeto30_JetSubTotalRelativeUp":
            warnings.warn( "EMTree: Expected branch jetVeto30_JetSubTotalRelativeUp does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.jetVeto30_JetSubTotalScaleDown_branch and "jetVeto30_JetSubTotalScaleDown":
            warnings.warn( "EMTree: Expected branch jetVeto30_JetSubTotalScaleDown does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.jetVeto30_JetSubTotalScaleUp_branch and "jetVeto30_JetSubTotalScaleUp":
            warnings.warn( "EMTree: Expected branch jetVeto30_JetSubTotalScaleUp does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.mErsatzGenEta_branch and "mErsatzGenEta":
            warnings.warn( "EMTree: Expected branch mErsatzGenEta does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.mErsatzGenM_branch and "mErsatzGenM":
            warnings.warn( "EMTree: Expected branch mErsatzGenM does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.mErsatzGenPhi_branch and "mErsatzGenPhi":
            warnings.warn( "EMTree: Expected branch mErsatzGenPhi does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.mErsatzGenpT_branch and "mErsatzGenpT":
            warnings.warn( "EMTree: Expected branch mErsatzGenpT does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.mErsatzGenpX_branch and "mErsatzGenpX":
            warnings.warn( "EMTree: Expected branch mErsatzGenpX does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.mErsatzGenpY_branch and "mErsatzGenpY":
            warnings.warn( "EMTree: Expected branch mErsatzGenpY does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.mErsatzVispX_branch and "mErsatzVispX":
            warnings.warn( "EMTree: Expected branch mErsatzVispX does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.mErsatzVispY_branch and "mErsatzVispY":
            warnings.warn( "EMTree: Expected branch mErsatzVispY does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.mIsoMu22eta2p1Filter_branch and "mIsoMu22eta2p1Filter":
            warnings.warn( "EMTree: Expected branch mIsoMu22eta2p1Filter does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.mIsoMu24Filter_branch and "mIsoMu24Filter":
            warnings.warn( "EMTree: Expected branch mIsoMu24Filter does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.mIsoMu24eta2p1Filter_branch and "mIsoMu24eta2p1Filter":
            warnings.warn( "EMTree: Expected branch mIsoMu24eta2p1Filter does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.mIsoTkMu22eta2p1Filter_branch and "mIsoTkMu22eta2p1Filter":
            warnings.warn( "EMTree: Expected branch mIsoTkMu22eta2p1Filter does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.mIsoTkMu24Filter_branch and "mIsoTkMu24Filter":
            warnings.warn( "EMTree: Expected branch mIsoTkMu24Filter does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.mIsoTkMu24eta2p1Filter_branch and "mIsoTkMu24eta2p1Filter":
            warnings.warn( "EMTree: Expected branch mIsoTkMu24eta2p1Filter does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.mMatchesIsoMu24eta2p1Path_branch and "mMatchesIsoMu24eta2p1Path":
            warnings.warn( "EMTree: Expected branch mMatchesIsoMu24eta2p1Path does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.mMatchesIsoTkMu24Path_branch and "mMatchesIsoTkMu24Path":
            warnings.warn( "EMTree: Expected branch mMatchesIsoTkMu24Path does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.mMatchesIsoTkMu24eta2p1Path_branch and "mMatchesIsoTkMu24eta2p1Path":
            warnings.warn( "EMTree: Expected branch mMatchesIsoTkMu24eta2p1Path does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.mMatchesMu19Tau20Filter_branch and "mMatchesMu19Tau20Filter":
            warnings.warn( "EMTree: Expected branch mMatchesMu19Tau20Filter does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.mMatchesMu19Tau20Path_branch and "mMatchesMu19Tau20Path":
            warnings.warn( "EMTree: Expected branch mMatchesMu19Tau20Path does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.mMatchesMu19Tau20sL1Filter_branch and "mMatchesMu19Tau20sL1Filter":
            warnings.warn( "EMTree: Expected branch mMatchesMu19Tau20sL1Filter does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.mMatchesMu19Tau20sL1Path_branch and "mMatchesMu19Tau20sL1Path":
            warnings.warn( "EMTree: Expected branch mMatchesMu19Tau20sL1Path does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.singleE27TightGroup_branch and "singleE27TightGroup":
            warnings.warn( "EMTree: Expected branch singleE27TightGroup does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.singleE27TightPass_branch and "singleE27TightPass":
            warnings.warn( "EMTree: Expected branch singleE27TightPass does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.singleE27TightPrescale_branch and "singleE27TightPrescale":
            warnings.warn( "EMTree: Expected branch singleE27TightPrescale does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.singleE27eta2p1LooseGroup_branch and "singleE27eta2p1LooseGroup":
            warnings.warn( "EMTree: Expected branch singleE27eta2p1LooseGroup does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.singleE27eta2p1LoosePass_branch and "singleE27eta2p1LoosePass":
            warnings.warn( "EMTree: Expected branch singleE27eta2p1LoosePass does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.singleE27eta2p1LoosePrescale_branch and "singleE27eta2p1LoosePrescale":
            warnings.warn( "EMTree: Expected branch singleE27eta2p1LoosePrescale does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.singleE27eta2p1TightGroup_branch and "singleE27eta2p1TightGroup":
            warnings.warn( "EMTree: Expected branch singleE27eta2p1TightGroup does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.singleE27eta2p1TightPass_branch and "singleE27eta2p1TightPass":
            warnings.warn( "EMTree: Expected branch singleE27eta2p1TightPass does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.singleE27eta2p1TightPrescale_branch and "singleE27eta2p1TightPrescale":
            warnings.warn( "EMTree: Expected branch singleE27eta2p1TightPrescale does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.singleIsoMu22eta2p1Group_branch and "singleIsoMu22eta2p1Group":
            warnings.warn( "EMTree: Expected branch singleIsoMu22eta2p1Group does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.singleIsoMu22eta2p1Prescale_branch and "singleIsoMu22eta2p1Prescale":
            warnings.warn( "EMTree: Expected branch singleIsoMu22eta2p1Prescale does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.singleIsoTkMu22eta2p1Group_branch and "singleIsoTkMu22eta2p1Group":
            warnings.warn( "EMTree: Expected branch singleIsoTkMu22eta2p1Group does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.singleIsoTkMu22eta2p1Prescale_branch and "singleIsoTkMu22eta2p1Prescale":
            warnings.warn( "EMTree: Expected branch singleIsoTkMu22eta2p1Prescale does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.singleIsoTkMu24Group_branch and "singleIsoTkMu24Group":
            warnings.warn( "EMTree: Expected branch singleIsoTkMu24Group does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.singleIsoTkMu24Prescale_branch and "singleIsoTkMu24Prescale":
            warnings.warn( "EMTree: Expected branch singleIsoTkMu24Prescale does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.singleIsoTkMu24eta2p1Group_branch and "singleIsoTkMu24eta2p1Group":
            warnings.warn( "EMTree: Expected branch singleIsoTkMu24eta2p1Group does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.singleIsoTkMu24eta2p1Pass_branch and "singleIsoTkMu24eta2p1Pass":
            warnings.warn( "EMTree: Expected branch singleIsoTkMu24eta2p1Pass does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.singleIsoTkMu24eta2p1Prescale_branch and "singleIsoTkMu24eta2p1Prescale":
            warnings.warn( "EMTree: Expected branch singleIsoTkMu24eta2p1Prescale does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.singleMu19eta2p1LooseTau20Group_branch and "singleMu19eta2p1LooseTau20Group":
            warnings.warn( "EMTree: Expected branch singleMu19eta2p1LooseTau20Group does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.singleMu19eta2p1LooseTau20Prescale_branch and "singleMu19eta2p1LooseTau20Prescale":
            warnings.warn( "EMTree: Expected branch singleMu19eta2p1LooseTau20Prescale does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.singleMu19eta2p1LooseTau20singleL1Group_branch and "singleMu19eta2p1LooseTau20singleL1Group":
            warnings.warn( "EMTree: Expected branch singleMu19eta2p1LooseTau20singleL1Group does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.singleMu19eta2p1LooseTau20singleL1Prescale_branch and "singleMu19eta2p1LooseTau20singleL1Prescale":
            warnings.warn( "EMTree: Expected branch singleMu19eta2p1LooseTau20singleL1Prescale does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.singleMu21eta2p1LooseTau20singleL1Group_branch and "singleMu21eta2p1LooseTau20singleL1Group":
            warnings.warn( "EMTree: Expected branch singleMu21eta2p1LooseTau20singleL1Group does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.singleMu21eta2p1LooseTau20singleL1Pass_branch and "singleMu21eta2p1LooseTau20singleL1Pass":
            warnings.warn( "EMTree: Expected branch singleMu21eta2p1LooseTau20singleL1Pass does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.singleMu21eta2p1LooseTau20singleL1Prescale_branch and "singleMu21eta2p1LooseTau20singleL1Prescale":
            warnings.warn( "EMTree: Expected branch singleMu21eta2p1LooseTau20singleL1Prescale does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.singleMu23SingleE12DZGroup_branch and "singleMu23SingleE12DZGroup":
            warnings.warn( "EMTree: Expected branch singleMu23SingleE12DZGroup does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.singleMu23SingleE12DZPass_branch and "singleMu23SingleE12DZPass":
            warnings.warn( "EMTree: Expected branch singleMu23SingleE12DZPass does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.singleMu23SingleE12DZPrescale_branch and "singleMu23SingleE12DZPrescale":
            warnings.warn( "EMTree: Expected branch singleMu23SingleE12DZPrescale does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.singleMu23SingleE8Group_branch and "singleMu23SingleE8Group":
            warnings.warn( "EMTree: Expected branch singleMu23SingleE8Group does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.singleMu23SingleE8Pass_branch and "singleMu23SingleE8Pass":
            warnings.warn( "EMTree: Expected branch singleMu23SingleE8Pass does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.singleMu23SingleE8Prescale_branch and "singleMu23SingleE8Prescale":
            warnings.warn( "EMTree: Expected branch singleMu23SingleE8Prescale does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.singleMu8SingleE23DZGroup_branch and "singleMu8SingleE23DZGroup":
            warnings.warn( "EMTree: Expected branch singleMu8SingleE23DZGroup does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.singleMu8SingleE23DZPass_branch and "singleMu8SingleE23DZPass":
            warnings.warn( "EMTree: Expected branch singleMu8SingleE23DZPass does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.singleMu8SingleE23DZPrescale_branch and "singleMu8SingleE23DZPrescale":
            warnings.warn( "EMTree: Expected branch singleMu8SingleE23DZPrescale does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.singleTau140Group_branch and "singleTau140Group":
            warnings.warn( "EMTree: Expected branch singleTau140Group does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.singleTau140Pass_branch and "singleTau140Pass":
            warnings.warn( "EMTree: Expected branch singleTau140Pass does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.singleTau140Prescale_branch and "singleTau140Prescale":
            warnings.warn( "EMTree: Expected branch singleTau140Prescale does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.vbfMass_JetSubTotalAbsoluteDown_branch and "vbfMass_JetSubTotalAbsoluteDown":
            warnings.warn( "EMTree: Expected branch vbfMass_JetSubTotalAbsoluteDown does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.vbfMass_JetSubTotalAbsoluteUp_branch and "vbfMass_JetSubTotalAbsoluteUp":
            warnings.warn( "EMTree: Expected branch vbfMass_JetSubTotalAbsoluteUp does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.vbfMass_JetSubTotalMCDown_branch and "vbfMass_JetSubTotalMCDown":
            warnings.warn( "EMTree: Expected branch vbfMass_JetSubTotalMCDown does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.vbfMass_JetSubTotalMCUp_branch and "vbfMass_JetSubTotalMCUp":
            warnings.warn( "EMTree: Expected branch vbfMass_JetSubTotalMCUp does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.vbfMass_JetSubTotalPileUpDown_branch and "vbfMass_JetSubTotalPileUpDown":
            warnings.warn( "EMTree: Expected branch vbfMass_JetSubTotalPileUpDown does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.vbfMass_JetSubTotalPileUpUp_branch and "vbfMass_JetSubTotalPileUpUp":
            warnings.warn( "EMTree: Expected branch vbfMass_JetSubTotalPileUpUp does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.vbfMass_JetSubTotalPtDown_branch and "vbfMass_JetSubTotalPtDown":
            warnings.warn( "EMTree: Expected branch vbfMass_JetSubTotalPtDown does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.vbfMass_JetSubTotalPtUp_branch and "vbfMass_JetSubTotalPtUp":
            warnings.warn( "EMTree: Expected branch vbfMass_JetSubTotalPtUp does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.vbfMass_JetSubTotalRelativeDown_branch and "vbfMass_JetSubTotalRelativeDown":
            warnings.warn( "EMTree: Expected branch vbfMass_JetSubTotalRelativeDown does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.vbfMass_JetSubTotalRelativeUp_branch and "vbfMass_JetSubTotalRelativeUp":
            warnings.warn( "EMTree: Expected branch vbfMass_JetSubTotalRelativeUp does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.vbfMass_JetSubTotalScaleDown_branch and "vbfMass_JetSubTotalScaleDown":
            warnings.warn( "EMTree: Expected branch vbfMass_JetSubTotalScaleDown does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.vbfMass_JetSubTotalScaleUp_branch and "vbfMass_JetSubTotalScaleUp":
            warnings.warn( "EMTree: Expected branch vbfMass_JetSubTotalScaleUp does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.vbfNJets20_JetEnDown_branch and "vbfNJets20_JetEnDown":
            warnings.warn( "EMTree: Expected branch vbfNJets20_JetEnDown does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.vbfNJets20_JetEnUp_branch and "vbfNJets20_JetEnUp":
            warnings.warn( "EMTree: Expected branch vbfNJets20_JetEnUp does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.vbfNJets30_JetEnDown_branch and "vbfNJets30_JetEnDown":
            warnings.warn( "EMTree: Expected branch vbfNJets30_JetEnDown does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.vbfNJets30_JetEnUp_branch and "vbfNJets30_JetEnUp":
            warnings.warn( "EMTree: Expected branch vbfNJets30_JetEnUp does not exist!"                " It will crash if you try and use it!",Warning)
    ...
    property eMatchesEle24Tau20L1Filter:
        def __get__(self):
            self.eMatchesEle24Tau20L1Filter_branch.GetEntry(self.localentry, 0)
            return self.eMatchesEle24Tau20L1Filter_value

    property eMatchesEle24Tau20L1Path:
        def __get__(self):
            self.eMatchesEle24Tau20L1Path_branch.GetEntry(self.localentry, 0)
            return self.eMatchesEle24Tau20L1Path_value
    ...
    property e_m_MvaMet:
        def __get__(self):
            self.e_m_MvaMet_branch.GetEntry(self.localentry, 0)
            return self.e_m_MvaMet_value

    property e_m_MvaMetCovMatrix00:
        def __get__(self):
            self.e_m_MvaMetCovMatrix00_branch.GetEntry(self.localentry, 0)
            return self.e_m_MvaMetCovMatrix00_value

    property e_m_MvaMetCovMatrix01:
        def __get__(self):
            self.e_m_MvaMetCovMatrix01_branch.GetEntry(self.localentry, 0)
            return self.e_m_MvaMetCovMatrix01_value

    property e_m_MvaMetCovMatrix10:
        def __get__(self):
            self.e_m_MvaMetCovMatrix10_branch.GetEntry(self.localentry, 0)
            return self.e_m_MvaMetCovMatrix10_value

    property e_m_MvaMetCovMatrix11:
        def __get__(self):
            self.e_m_MvaMetCovMatrix11_branch.GetEntry(self.localentry, 0)
            return self.e_m_MvaMetCovMatrix11_value

    property e_m_MvaMetPhi:
        def __get__(self):
            self.e_m_MvaMetPhi_branch.GetEntry(self.localentry, 0)
            return self.e_m_MvaMetPhi_value
    ...
    property e_m_collinearmass_EleEnDown:
        def __get__(self):
            self.e_m_collinearmass_EleEnDown_branch.GetEntry(self.localentry, 0)
            return self.e_m_collinearmass_EleEnDown_value

    property e_m_collinearmass_EleEnUp:
        def __get__(self):
            self.e_m_collinearmass_EleEnUp_branch.GetEntry(self.localentry, 0)
            return self.e_m_collinearmass_EleEnUp_value
    ...
    property e_m_collinearmass_MuEnDown:
        def __get__(self):
            self.e_m_collinearmass_MuEnDown_branch.GetEntry(self.localentry, 0)
            return self.e_m_collinearmass_MuEnDown_value

    property e_m_collinearmass_MuEnUp:
        def __get__(self):
            self.e_m_collinearmass_MuEnUp_branch.GetEntry(self.localentry, 0)
            return self.e_m_collinearmass_MuEnUp_value
