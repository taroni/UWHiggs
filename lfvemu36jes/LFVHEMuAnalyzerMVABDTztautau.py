...
class LFVHEMuAnalyzerMVABDTztautau(MegaBase):
    tree = 'em/final/Ntuple'
    def __init__(self, tree, outfile, **kwargs):

        self.channel='EMu'
        super(LFVHEMuAnalyzerMVABDTztautau, self).__init__(tree, outfile, **kwargs)
...
#        print eisocorr
        ...
        return pu*muidcorr*muisocorr*mutrcorr*mutrkcorr*eidisocorr0p10*etrkcorr*topptreweight
...
#            print "non-repeat"
            ...
            if not selections.lepton_id_iso(row, 'e', 'eid15Loose_etauiso1',eIDwp='WP90'): continue
...
#            if btagweight<0:btagweight=0
            ...
            isElecTight=False
            if selections.lepton_id_iso(row, 'e', 'eid15Loose_etauiso0p1',eIDwp='WP90'): 
