...
python getQCDBDT.py $analyzer $luminosity $jobid $analtype $sys 
python getQCDforcombineBDT.py $analyzer $luminosity $jobid $analtype $sys   #get the same without sysuncertainty in histos, combine script already adds them
...
python prepHistosBDT.py $analyzer $luminosity $jobid $analtype
