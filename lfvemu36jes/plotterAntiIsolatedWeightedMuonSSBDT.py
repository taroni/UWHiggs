...
blindpath="antiIsolatedweightedmuon/os/.*ass*"
#blind_region=[100, 200] if blind else None
if 'BDT2' in sys.argv[4]:
    blind_region=[0.0,0.3]
    blindpath="antiIsolatedweightedmuon/os/.*BDT*"
...
new_mc_samples.extend(['WGamma','SMH','SingleT','EWKDiboson','TT','Wplus','DYLL','ZTT'])
...
if not no_plots:
   ...
   for regions in ['antiIsolatedweightedmuon']:
