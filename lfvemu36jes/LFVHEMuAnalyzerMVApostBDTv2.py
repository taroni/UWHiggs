...
#        self.var_d_star =['mTmuMet_','mTeMet_','deltaPhimue_','eDphiPFMet_','mDphiPFMet_','metEt_','numjets_','vbfMass_','vbfDeltaEta_','deltaeta_mu_e:=mEta_-eEta_'] 
        ...
        self.xml_name = os.path.join(os.getcwd(),"newBDT2/weights/TMVAClassification_BDT.weights.xml")  #weights from BDT
...
#                print "btagweight,nbtagged,row.jb1pt,row.jb1hadronflavor,row.jb2pt,row.jb2hadronflavor"," ",btagweight," ",nbtagged," ",row.jb1pt," ",row.jb1hadronflavor," ",row.jb2pt," ",row.jb2hadronflavor
            ...
            self.var_d_00 ={'mTmuMet_':row.mMtToPfMet_type1,'mTeMet_':row.eMtToPfMet_type1,'eDphiPFMet_':row.eDPhiToPfMet_type1,'mDphiPFMet_':row.mDPhiToPfMet_type1,'lepAsym_':leptonAsymmetry}
            ...
            for sys in self.sysdir:
                ...
                self.var_d_0 ={'mTmuMet_':shifted_mMtToPfMet,'mTeMet_':shifted_eMtToPfMet,'eDphiPFMet_':shifted_eDPhiToPfMet,'mDphiPFMet_':sh
ifted_mDPhiToPfMet,'lepAsym_':leptonAsymmetry}
