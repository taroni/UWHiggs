...
fileName = "preprocessed_inputs/Simple"+args.analyzer+str(args.Lumi)+"/"+selection_region+"/"+args.region+"/"+args.inputFile
...
#    categ  = ROOT.TPaveText(0.17, 0.655, 0.45, 0.655+0.155, "NDC")
    ...
    if args.suffix=='presel':
        ...
        if isLog:
            ...
            c.SaveAs("plots/"+analyzer+str(args.Lumi)+TTbar_DD+"/preselection/"+args.region+"/log_"+cat+"_"+variable+".png")
    #       c.SaveAs("plots/"+analyzer+str(args.Lumi)+TTbar_DD+"/preselection/"+"log_"+cat+"_"+variable+".pdf")
            ...
            c.SaveAs("plots/"+analyzer+str(args.Lumi)+TTbar_DD+"/preselection/"+args.region+"/"+cat+"_"+variable+".png")
    #       c.SaveAs("plots/"+analyzer+str(args.Lumi)+TTbar_DD+"/preselection/"+cat+"_"+variable+".pdf")
        ...
        if isLog:
            ...
            c.SaveAs("plots/"+analyzer+str(args.Lumi)+TTbar_DD+"/selection/"+args.region+"/log_"+cat+"_"+variable+".png")
    #       c.SaveAs("plots/"+analyzer+str(args.Lumi)+TTbar_DD+"/selection/"+"log_"+cat+"_"+variable+".pdf")
            ...
            c.SaveAs("plots/"+analyzer+str(args.Lumi)+TTbar_DD+"/selection/"+args.region+"/"+cat+"_"+variable+".png")
