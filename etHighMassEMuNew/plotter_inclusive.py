...
analyzer="Simple"+args.analyzer
variable=args.variable
channel = args.channel
higgsSF = args.higgsSF
fileName = "preprocessed_inputs/Simple"+args.analyzer+str(args.Lumi)+"/inclusive/"+args.region+"/"+args.inputFile
Lumi=args.Lumi
...
hist_ZTT=file.Get("etaumu_inclus").Get("ZTauTau")
if args.region!='ss':
    hist_Fakes=file.Get("etaumu_inclus").Get("QCD")
#hist_Fakes.Add(file.Get("mutaue_inclus").Get("W"))
hist_W=file.Get("etaumu_inclus").Get("W")
if args.is_TT_DD==0:
    hist_TT=file.Get("etaumu_inclus").Get("TT")
else:
    hist_TT=file.Get("etaumu_inclus").Get("TT_DD")
hist_TT.Add(file.Get("etaumu_inclus").Get("T"))
...
#    sig_hist=file.Get("mutaue_inclus").Get("LFV"+signal)
    signal_histos.append((file.Get("etaumu_inclus").Get("LFV"+signal),"LFV"+signal))
...
hist_VV=file.Get("etaumu_inclus").Get("Diboson")
hist_data=file.Get("etaumu_inclus").Get("data_obs")
hist_ZL=file.Get("etaumu_inclus").Get("Zothers")
...
mymax=hist_data.GetBinContent(hist_data.GetMaximumBin())
...
categ.AddText("e#tau_{#mu}, inclusive")
categ.Draw("same")
...
c.SaveAs("plots/"+analyzer+str(args.Lumi)+TTbar_DD+"/inclusive/"+args.region+"/"+variable.replace("#","")+".png")
