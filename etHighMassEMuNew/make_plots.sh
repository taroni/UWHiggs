...
##python plotter.py --lumi $luminosity --inputFile h_vismass.root --numCategories $numcategories --analyzer $analyzer --channel "em"  --suffix "presel" --blind 1 --isLog 1 --signals $my_signals --region ss --var vismass
##python plotter.py --lumi $luminosity --inputFile mPt.root --numCategories $numcategories --analyzer $analyzer --channel "em"  --suffix "presel" --blind 1 --isLog 1 --signals $my_signals --region ss --var mPt
##python plotter.py --lumi $luminosity --inputFile ePt.root --numCategories $numcategories --analyzer $analyzer --channel "em"  --suffix "presel" --blind 1 --isLog 1 --signals $my_signals --region ss --var ePt
##python plotter.py --lumi $luminosity --inputFile mPFMET_Mt.root --numCategories $numcategories --analyzer $analyzer --channel "em"  --suffix "presel" --blind 1 --isLog 1 --signals $my_signals --region ss --var mtMuMet
##python plotter.py --lumi $luminosity --inputFile ePFMET_Mt.root --numCategories $numcategories --analyzer $analyzer --channel "em"  --suffix "presel" --blind 1 --isLog 1 --signals $my_signals --region ss --var mtEMet
##python plotter.py --lumi $luminosity --inputFile Met.root --numCategories $numcategories --analyzer $analyzer --channel "em"  --suffix "presel" --blind 1 --isLog 1 --signals $my_signals --region ss --var met
##python plotter.py --lumi $luminosity --inputFile ePFMET_DeltaPhi.root --numCategories $numcategories --analyzer $analyzer --channel "em"  --suffix "presel" --blind 1  --signals $my_signals --region ss --var dphiEMet
##python plotter.py --lumi $luminosity --inputFile mPFMET_DeltaPhi.root --numCategories $numcategories --analyzer $analyzer --channel "em"  --suffix "presel" --blind 1  --signals $my_signals --region ss --var dphiMuMet
...
#make preselection plots
##python plotter.py --lumi $luminosity --inputFile h_collmass_pfmet.root --numCategories $numcategories --analyzer $analyzer --channel "em"  --suffix "selected" --blind 1 --isLog 1 --higgsSF 1 --signals $my_signals --region ss
##python plotter.py --lumi $luminosity --inputFile h_vismass.root --numCategories $numcategories --analyzer $analyzer --channel "em"  --suffix "selected" --blind 1 --isLog 1 --signals $my_signals --region ss --var vismass --higgsSF 1
