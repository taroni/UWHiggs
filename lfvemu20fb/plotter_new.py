...
embedded = False
print jobid
files=  glob.glob('LFVHEMuAnalyzerMVA_esffixed_plot/*.root')
#print "files",files
outputdir = 'newplots/%s/lfvemu/LFVHEMuAnalyzerMVA_esffixed_plot/' % (jobid)
...
new_mc_samples.extend(['WGamma','SingleT','EWKDiboson','SMH','TT','QCD','Wplus','DYLL'])
