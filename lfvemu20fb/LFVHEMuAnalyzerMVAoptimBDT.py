...
class LFVHEMuAnalyzerMVAoptimBDT(MegaBase):
    tree = 'em/final/Ntuple'
    def __init__(self, tree, outfile, **kwargs):
        self.channel='EMu'
        super(LFVHEMuAnalyzerMVAoptimBDT, self).__init__(tree, outfile, **kwargs)
        target = os.path.basename(os.environ['megatarget'])
        self.var_d_star =['mTmuMet_','mTeMet_','eDphiPFMet_','mDphiPFMet_','lepAsym_'] 
        self.xml_name = os.path.join(os.getcwd(),"BDTwithDY/weights/TMVAClassification_BDT.weights.xml")  #weights from BDT
