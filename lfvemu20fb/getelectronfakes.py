...
class GetFAKES(object):
	def __init__(self):
		self.histos={}
	        ...
	        for var in vars:
	        	for sign in ['antiIsolatedweightedelectron/ss','antiIsolatedweightedelectron/os']:
	        		for j in range(2):
...
#						print "FAKES",self.histoFAKES.Integral()
		...
		self.outputfile=ROOT.TFile("electronFakesMethod2.root","recreate")
		self.outputfile.cd()
...
#			print self.dir0
			self.dir0.Cd("electronFakesMethod2.root:/"+key[0])
#    print dir0
#			print histos[key]
