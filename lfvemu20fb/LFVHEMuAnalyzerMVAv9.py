...
fakerateWeightGetter =FakeRate2D.make_fakerate2D()
...
#        print eisocorr
        ...
        if region=='eLoosemTight':
            return pu*muidcorr*muisocorr*mutrcorr*eidcorr*mutrkcorr*eisocorr0p15*etrkcorr*wtzpt*topptreweight
        else:
            return pu*muidcorr*muisocorr*mutrcorr*eidcorr*mutrkcorr*eisocorr0p10*etrkcorr*wtzpt*topptreweight
