...
class LFVHEMuAnalyzerMVA_ichepmuonid(MegaBase):
    tree = 'em/final/Ntuple'
    def __init__(self, tree, outfile, **kwargs):

        self.channel='EMu'
        super(LFVHEMuAnalyzerMVA_ichepmuonid, self).__init__(tree, outfile, **kwargs)
    ...
    def fill_histos(self, row, f=None,region=None,sys=''):
        ...
        if region!='signal' :
            ...
            if region=='eTightmLoose' :
                ...
                frweight_array=fakerateWeight(row.ePt,abs(row.eEta))
                efr_weights = [1,frweight_arrfakerateWeightay[0],frweight_array[0]+frweight_array[1],frweight_array[0]-frweight_array[1]]
