...
class LFVHEMuAnalyzerMVA_mutrk(MegaBase):
    tree = 'em/final/Ntuple'
    def __init__(self, tree, outfile, **kwargs):

        self.channel='EMu'
        super(LFVHEMuAnalyzerMVA_mutrk, self).__init__(tree, outfile, **kwargs)
...
#        self.sysdir=['nosys']
        if self.is_WJet:
            ...
            self.binned_weight=[0.000268675152,0.000026762697,0.0000256444,0.000031823574,0.000173817909]
        else:
