...
class BasePlotter(Plotter):
    def __init__ (self, files, lumifiles, outputdir, blind_region=None, forceLumi=-1, use_embedded=False): 
        cwd = os.getcwd()
        self.period = '13TeV'
        self.sqrts  = 13
        ...
        files     = glob.glob('results/%s/LFVEMuAnalyserGen/*.root' % jobid)
        ...
        ###self.views['fakes'] = {'view' : self.make_fakes('t')} # comment if no data driven mis-identified background
