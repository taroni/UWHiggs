...
class div_2j_LFVHEMuAnalyzerMVA(MegaBase):
    tree = 'em/final/Ntuple'
    def __init__(self, tree, outfile, **kwargs):

        self.channel='EMu'
        super(div_2j_LFVHEMuAnalyzerMVA, self).__init__(tree, outfile, **kwargs)
...
#        threshold=[]
        sign=[ 'ss','os']
        jetN = [0,1,20,21,3] # 20- 2 jets glu glu ; 21- 2jets vbf
        folder=[]
...
#       looseList = ['mLoose/']
 ...
 #           ptthreshold = [30]
            ...
            if not bool(row.singleIsoMu22Pass or row.singleIsoTkMu22Pass) : continue   #notrigger in new MC; add later
