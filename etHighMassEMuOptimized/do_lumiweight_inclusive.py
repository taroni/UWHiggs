...
category="etaumu_inclus"

if not os.path.exists(args.outputdir+"/Simple"+args.analyzer_name+str(args.Lumi)+"/inclusive"):
   os.makedirs(args.outputdir+"/Simple"+args.analyzer_name+str(args.Lumi)+"/inclusive")
if not os.path.exists(args.outputdir+"/Simple"+args.analyzer_name+str(args.Lumi)+"/inclusive/"+args.region):
   os.makedirs(args.outputdir+"/Simple"+args.analyzer_name+str(args.Lumi)+"/inclusive/"+args.region)
...
#            print "found neg bin  ",j
   ...
   outputfile=ROOT.TFile(args.outputdir+"/Simple"+args.analyzer_name+str(args.Lumi)+"/inclusive/"+args.region+"/"+var[0]+".root","recreate")
