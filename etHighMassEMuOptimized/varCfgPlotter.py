...
def getCategories( channel="et", suffix="",num_categories=3 ) :
    ...
    if channel=="em":
        if int(num_categories)==3:
            categories[0]="etaumu_0jet_"+suffix
            categories[1]="etaumu_1jet_"+suffix
            categories[2]="etaumu_2jet_"+suffix
        elif int(num_categories)==2:
            categories[0]="etaumu_01jet_"+suffix
            categories[1]="etaumu_rest_"+suffix
    if channel=="mt":
...
#       infoMap["QCD"] = [["QCD","W"+shift],"W/QCD","f","#ffccff",0.30]
    ...
    if channel=="me" or channel=="mt" or channel=='em':
