...
SMH = views.StyleView(views.SumView( *[ plotter.get_view(regex) for regex in filter(lambda x : 'HToTauTau' in x , mc_samples)]), **remove_name_entry(data_styles['SMHTauTau*']))
...
new_mc_samples.extend(['EWKDiboson', 'SMH', 'Wplus', 'DYLL'
])
