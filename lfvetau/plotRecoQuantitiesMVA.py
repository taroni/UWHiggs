...
parser.add_argument('--forceLumi', dest='lumi',  action='store', type=float,
                    default=-1, help='desired lumi')



args = parser.parse_args()
print args, args.lumi
print ''
print ''
print ''
...
plotter = BasePlotter(files, outputdir,  blind_region, forceLumi=args.lumi, use_embedded=embedded)
if not args.no_plots:
   ...
   histo_info = [
      ...
      ##('vbfj1eta', 'vbf leading jet #eta', 1),
      ##('vbfj2eta', 'vbf subleading jet #eta', 1),
      ##('tDecayMode', '#tau decay mode', 1)
   ]
...
if not args.no_shapes:
   ...
   for njets, cat_name, rebin in jets_names:
      ...
      unc_conf_lines, unc_vals_lines = plotter.write_shapes( 
         signal_region % njets, 'h_collmass_pfmet', output_dir,  rebin=rebin, br_strenght=1.)
