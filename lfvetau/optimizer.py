...
_0jets = {
   'tPt'  : range(20,50,5),
   'ePt'  : range(25,50,5),
   'dphi' : [3.00, 2.7, 2.4, 2.2, 2.0],
   'tMtToPfMet_type1' : range(30,80,10),
}
_0jets_default = {
   'tPt' : 0,
   'ePt' : 0,
   'dphi': 0,
   'tMtToPfMet_type1' :50000,
}
...
def _get_0jet_regions(tPt, ePt, dphi, tMtToPfMet):
   ...
   pass_tMtToPfMet = [i for i in _0jets['tMtToPfMet_type1'] if tMtToPfMet < i] 
   ...
   pass_default_tMtToPfMet = tMtToPfMet < _0jets_default['tMtToPfMet_type1']
...
_2jets = {
    ...
    'ePt'  : range(25,50,5),
    'tMtToPfMet' : range(20,70,10),
    'vbf_mass' : range(100, 600, 50),
    'vbf_deta' : [1.5, 2.0, 2.5, 3.0, 3.5, 4.0],
}
_2jets_default = {
    'tPt' : 0,
    'ePt' : 0,
...
_2jet_region_templates = ['tPt%i', 'ePt%i', 'tMtToPfMet%i', 'vbfMass%i', 'vbfDeta%.1f' ]#'tPt%i_ePt%i_tMtToPfMet%i_vbf_mass%i_vbf_deta%.1f'
...
##
ret0 = []
defaults = [_0jets_default['tPt'], _0jets_default['ePt'], _0jets_default['dphi'], _0jets_default['tMtToPfMet_type1']]
cuts0 = [_0jets['tPt'], _0jets['ePt'], _0jets['dphi'], _0jets['tMtToPfMet_type1']]
