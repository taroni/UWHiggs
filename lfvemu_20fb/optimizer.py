...
_0jet_region_templates = ['mPt%i'] #'mPt%i_ePt%i_dphi%.2f_mMtToPfMet%i'
#_0jet_region_templates = ['mPt%i', 'ePt%i', 'dphi%.2f', 'mMtToPfMet%i','eMtToPfMet%i','dphiMetToE%.2f'] #'mPt%i_ePt%i_dphi%.2f_mMtToPfMet%i'

def _get_0jet_regions(mPt, ePt, dphi, mMtToPfMet,eMtToPfMet,dphiMetToE,dphiMetToMu,deltaR,scaledePt):
...
_1jet_region_templates =  ['dphi%.2f' ] 
def _get_1jet_regions(mPt, ePt, dphi, mMtToPfMet,eMtToPfMet,dphiMetToE,dphiMetToMu,deltaR,scaledePt):
...
_2jetgg_region_templates =  ['mMtToPfMet%i' ] 

def _get_2jetgg_regions(mPt, ePt, mMtToPfMet,eMtToPfMet,dphiMetToE,dphiMetToMu,vbf_mass, vbf_deta,deltaR,scaledePt):
...
_2jetvbf_region_templates =  ['mMtToPfMet%i' ] 

def _get_2jetvbf_regions(mPt, ePt, mMtToPfMet,eMtToPfMet,dphiMetToE,dphiMetToMu,vbf_mass, vbf_deta,deltaR,scaledePt):
