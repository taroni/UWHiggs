...
plotter = BasePlotter(files, outputdir, blind_region,use_embedded=embedded,blind_path="antiIsolated/os/.*ass*")
...
new_mc_samples.extend(['SMH','WGamma','SingleT','EWKDiboson','TT','Wplus','QCD','DYLL'])
