...
class LFVHEMuAnalyzerMVA_postBDTwithpt_depth3(MegaBase):
    tree = 'em/final/Ntuple'
    def __init__(self, tree, outfile, **kwargs):

        self.channel='EMu'
        super(LFVHEMuAnalyzerMVA_postBDTwithpt_depth3, self).__init__(tree, outfile, **kwargs)
...
#        self.var_d_star =['mTmuMet_','mTeMet_','deltaPhimue_','eDphiPFMet_','mDphiPFMet_','metEt_','numjets_','vbfMass_','vbfDeltaEta_','deltaeta_mu_e:=mEta_-eEta_'] 
        self.var_d_star =['ePt_','mPt_','mTmuMet_','deltaPhimue_','eDphiPFMet_','numjets_','vbfMass_'] 
        self.xml_name = os.path.join(os.getcwd(),"BDTwithpt_depth3/weights/TMVAClassification_BDT.weights.xml")  #weights from BDT
...
#                print "btagweight,nbtagged,row.jb1pt,row.jb1flavor,row.jb2pt,row.jb2flavor"," ",btagweight," ",nbtagged," ",row.jb1pt," ",row.jb1flavor," ",row.jb2pt," ",row.jb2flavor
            ...
            if jetN>3:
                jetN=3
            self.var_d_20 ={'ePt_':row.ePt,'mPt_':row.mPt,'mTmuMet_':row.mMtToPfMet_type1,'deltaPhimue_':row.e_m_DPhi,'eDphiPFMet_':row.eDPhiToPfMet_type1,'numjets_':row.jetVeto30,'vbfMass_':row.vbfMass}               
            self.var_d_00 ={'ePt_':row.ePt,'mPt_':row.mPt,'mTmuMet_':row.mMtToPfMet_type1,'deltaPhimue_':row.e_m_DPhi,'eDphiPFMet_':row.eDPhiToPfMet_type1,'numjets_':row.jetVeto30,'vbfMass_':0.01}
            ...
            for sys in self.sysdir:
                ...
                self.var_d_0 ={'ePt_':row.ePt,'mPt_':row.mPt,'mTmuMet_':shifted_mMtToPfMet,'deltaPhimue_':row.e_m_DPhi,'eDphiPFMet_':shifted_eDPhiToPfMet,'numjets_':shifted_jetVeto30,'vbfMass_':0.01}
...
#                self.var_d_2 ={'mTmuMet_':shifted_mMtToPfMet,'mTeMet_':shifted_eMtToPfMet,'deltaPhimue_':deltaPhi(row.ePhi, row.mPhi),'eDphiPFMet_':shifted_eDPhiToPfMet,'mDphiPFMet_':shifted_mDPhiToPfMet,'metEt_':shifted_type1_pfMetEt,'numjets_':shifted_jetVeto30,'vbfMass_':shifted_vbfMass,'vbfDeltaEta_':shifted_vbfDeta,'deltaeta_mu_e:=mEta_-eEta_':deta}
                self.var_d_2 ={'ePt_':row.ePt,'mPt_':row.mPt,'mTmuMet_':shifted_mMtToPfMet,'deltaPhimue_':row.e_m_DPhi,'eDphiPFMet_':shifted_eDPhiToPfMet,'numjets_':shifted_jetVeto30,'vbfMass_':shifted_vbfMass}               
                ...
                if jn==0 or jn==1:
                    ...
                    if MVA0<-0.003:continue
                
                if jn==2:
                    MVA2=self.functor(**self.var_d_2)
                    if MVA2<-0.003:continue
