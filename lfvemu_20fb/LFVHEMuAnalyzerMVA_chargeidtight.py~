...
class LFVHEMuAnalyzerMVA_chargeidtight(MegaBase):
    tree = 'em/final/Ntuple'
    def __init__(self, tree, outfile, **kwargs):

        self.channel='EMu'
        super(LFVHEMuAnalyzerMVA_chargeidtight, self).__init__(tree, outfile, **kwargs)
...
#                print "btagweight,nbtagged,row.jb1pt,row.jb1flavor,row.jb2pt,row.jb2flavor"," ",btagweight," ",nbtagged," ",row.jb1pt," ",row.jb1flavor," ",row.jb2pt," ",row.jb2flavor
            ...
            if jetN==0:
                print "0 jet :",row.vbfMass,"  ",row.vbfDeta
            if jetN==1:
                print "1 jet :",row.vbfMass,"  ",row.vbfDeta
