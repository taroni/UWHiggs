...
def eSelection(row, name):
    if getattr( row, getVar(name,'Pt')) < 40:           
        #print "1"
        return False #was 20
    if getattr( row, getVar(name,'AbsEta')) > 2.3:      #as in H->tau_etau_h # was 2.3
        #print "2"
        return False #was 20
