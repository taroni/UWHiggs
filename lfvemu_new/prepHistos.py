...
for sign in ['os','subtracted/os','subtracted/ss']:
    for var in vars:
        for j in range(2):
            for i in range(4):
		     if j==0:
		     ...
		     datafile=ROOT.TFile("LFVHEMuAnalyzerMVA_esffixed_plot/data_obs.root")
		     ...
		     WGfile=ROOT.TFile("LFVHEMuAnalyzerMVA_esffixed_plot/WG.root","UPDATE")
		     ...
		     STfile=ROOT.TFile("LFVHEMuAnalyzerMVA_esffixed_plot/T.root","UPDATE")
		     ...
		     TTfile=ROOT.TFile("LFVHEMuAnalyzerMVA_esffixed_plot/TT.root","UPDATE")
		     ...
		     Dibosonsfile=ROOT.TFile("LFVHEMuAnalyzerMVA_esffixed_plot/Dibosons.root","UPDATE")
		     ...
		     DYfile=ROOT.TFile("LFVHEMuAnalyzerMVA_esffixed_plot/DY.root","UPDATE")
		     ...
		     WJETSMCfile=ROOT.TFile("LFVHEMuAnalyzerMVA_esffixed_plot/WJETSMC.root","UPDATE")
		     ...
		     vbfHTauTaufile=ROOT.TFile("LFVHEMuAnalyzerMVA_esffixed_plot/vbfHTauTau.root","UPDATE")
		     ...
		     ggHTauTaufile=ROOT.TFile("LFVHEMuAnalyzerMVA_esffixed_plot/ggHTauTau.root","UPDATE")
