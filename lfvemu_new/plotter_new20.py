...
embedded = False
print jobid
files=  glob.glob('LFVHEMuAnalyzerMVA_vertices_plot20/*.root')
#print "files",files
outputdir = 'newplots/%s/lfvemu/LFVHEMuAnalyzerMVA_vertices_plot20/' % (jobid)
...
new_mc_samples.extend(['WGamma','SingleT','EWKDiboson','SMH','TT','Wplus','DYLL'])
...
##      ('mPFMETDeltaPhi_vs_ePFMETDeltaPhi','mPFMETDeltaPhi_vs_ePFMETDeltaPhi',1)
   ...
   for var, xlabel, rebin in histo_info1:
         plotter.plot_mc_vs_data_new('os', var, '0',rebin, xlabel,
