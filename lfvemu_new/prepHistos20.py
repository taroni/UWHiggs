    ...
    for var in vars:
        for j in range(2):
            for i in range(4):
		     ...
		     datafile=ROOT.TFile("LFVHEMuAnalyzerMVA_vertices_plot20/data_obs.root")
		     ...
		     WGfile=ROOT.TFile("LFVHEMuAnalyzerMVA_vertices_plot20/WG.root","UPDATE")
		     ...
		     STfile=ROOT.TFile("LFVHEMuAnalyzerMVA_vertices_plot20/T.root","UPDATE")
		     ...
		     TTfile=ROOT.TFile("LFVHEMuAnalyzerMVA_vertices_plot20/TT.root","UPDATE")
		     ...
		     Dibosonsfile=ROOT.TFile("LFVHEMuAnalyzerMVA_vertices_plot20/Dibosons.root","UPDATE")
		     ...
		     DYfile=ROOT.TFile("LFVHEMuAnalyzerMVA_vertices_plot20/DY.root","UPDATE")
		     ...
		     WJETSMCfile=ROOT.TFile("LFVHEMuAnalyzerMVA_vertices_plot20/WJETSMC.root","UPDATE")
		     ...
		     vbfHTauTaufile=ROOT.TFile("LFVHEMuAnalyzerMVA_vertices_plot20/vbfHTauTau.root","UPDATE")
		     ...
		     ggHTauTaufile=ROOT.TFile("LFVHEMuAnalyzerMVA_vertices_plot20/ggHTauTau.root","UPDATE")
